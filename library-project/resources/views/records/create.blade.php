    ...
    <div class="kotak">
        ...
        <div class="book">
            ...
            <div class="date-record">
                ...
                <input class="input-date" name="date_record" type="date" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-lg" placeholder="Join Date" value="{{(date("Y-m-d"))}}" >
            </div>
                    @error('date_record')
