    ...
    <form method="POST" action="/book/{{$buku->id}}" enctype="multipart/form-data">
        ...
        <div class="kotak">
            ...
            <div class="kotak-right">
                <div class="titlebook"><div class="judultitle">Title</div><input class="input" type="text" placeholder="Input Title" name="title" value="{{$buku->title}}"></div>
                <div class="titlebook"><div class="judultitle">Author</div><input  class="input" type="text" placeholder="Author" name="author" value="{{$buku->author}}"></div>
                <div class="titlebook"><div class="judultitle">Publisher</div><input class="input" type="text" placeholder="Publisher" name="publisher" value="{{$buku->publisher}}"></div>
                <div class="titlebook"><div class="judultitle">Publication Date</div><input class="input" type="date" placeholder="publication Date" name="publication_date" value="{{$buku->publication_date}}"></div>
