        ...
        <div class="kotak">
            ...
            <div class="kotak-right">
                <div class="titlebook">
                    ...
                    <input class="input" type="text" placeholder="Input Title" name="title">
                    @error('title')
                ...
                <div class="titlebook">
                    ...
                    <input class="input" type="text" placeholder="Publisher" name="publisher"></div>
                    @error('publisher')
                        <p style="color: red; font-size:13px; margin-left:7px;">{{$message}}</p>
                    @enderror
                <div class="titlebook">
                    <div class="judultitle">Publication Date</div>
                    <input class="input" type="date" placeholder="publication Date" name="publication_date"></div>
